...
SECRET_KEY = 'l_q!!y(n@xsu3(90xl8)+6v6_f62u)0cak)a8&^sg!vie3j7&2'
...
DATABASES = {
	'default': {
	    ...
	    'NAME': 'medicaltrial_db',#Name of the database created for this project
...
# Set the URL to redirect to after a successful logout
